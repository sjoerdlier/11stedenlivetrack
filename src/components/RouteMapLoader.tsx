...
export default function RouteMapLoader({ start, legSegments, statuses, checkinTimes }: RouteMapLoaderProps) {
  return <RouteMap start={start} legSegments={legSegments} statuses={statuses} checkinTimes={checkinTimes} />;
}
